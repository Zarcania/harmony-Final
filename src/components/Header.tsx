    ...
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-28">
          ...
          {/* Menu Burger Mobile */}
          <button
            className="lg:hidden relative w-10 h-10 flex flex-col items-center justify-center space-y-1 group z-20"
            onClick={() => setIsMobileMenuOpen(!isMobileMenuOpen)}
          >
            <span className={`block w-6 h-0.5 bg-harmonie-700 transition-all duration-300 ease-in-out ${
